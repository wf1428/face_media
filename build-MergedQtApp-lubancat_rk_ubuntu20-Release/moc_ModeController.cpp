...
QT_MOC_LITERAL(9, 127, 26), // "handleRecognitionSucceeded"
QT_MOC_LITERAL(10, 154, 22), // "reconcilePresenceLevel"
QT_MOC_LITERAL(11, 177, 5), // "valid"
QT_MOC_LITERAL(12, 183, 7), // "present"
QT_MOC_LITERAL(13, 191, 12), // "AppModeState"
QT_MOC_LITERAL(14, 204, 16), // "MultimediaActive"
QT_MOC_LITERAL(15, 221, 19), // "SwitchingToFaceGate"
QT_MOC_LITERAL(16, 241, 14), // "FaceGateActive"
QT_MOC_LITERAL(17, 256, 21), // "SwitchingToMultimedia"
QT_MOC_LITERAL(18, 278, 12) // "ShuttingDown"

    },
    "ModeController\0stateChanged\0\0"
    "ModeController::AppModeState\0state\0"
    "switchFailed\0message\0handlePresenceDetected\0"
    "handlePresenceLost\0handleRecognitionSucceeded\0"
    "reconcilePresenceLevel\0valid\0present\0"
    "AppModeState\0MultimediaActive\0"
    "SwitchingToFaceGate\0FaceGateActive\0"
    "SwitchingToMultimedia\0ShuttingDown"
};
...
static const uint qt_meta_data_ModeController[] = {
 ...
 // enum data: key, value
      14, uint(ModeController::AppModeState::MultimediaActive),
      15, uint(ModeController::AppModeState::SwitchingToFaceGate),
      16, uint(ModeController::AppModeState::FaceGateActive),
      17, uint(ModeController::AppModeState::SwitchingToMultimedia),
      18, uint(ModeController::AppModeState::ShuttingDown),
...
void ModeController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->handleRecognitionSucceeded(); break;
        case 5: _t->reconcilePresenceLevel((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
