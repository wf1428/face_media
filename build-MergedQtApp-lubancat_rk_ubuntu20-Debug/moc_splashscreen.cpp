...
#include "../MergedQtApp/components/splash/splashscreen.h"
...
QT_MOC_LITERAL(1, 13, 14), // "splashFinished"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14) // "onTimerTimeout"

    },
    "SplashScreen\0splashFinished\0\0"
    "onTimerTimeout"
};
...
void SplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->splashFinished(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SplashScreen::splashFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SplashScreen::splashFinished()
{
