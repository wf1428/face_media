/****************************************************************************
** Meta object code from reading C++ file 'CameraPreviewWidget.h'
**
...
#include "../MergedQtApp/modules/facegate/FaceGateQt/ui/CameraPreviewWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'CameraPreviewWidget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "CameraPreviewWidget\0clicked\0"
};
...
void CameraPreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CameraPreviewWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CameraPreviewWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraPreviewWidget::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraPreviewWidget::clicked()
{
